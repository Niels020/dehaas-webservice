...
const copy = {
  nl: {
    preview: "Bedankt voor het boeken van een gesprek.",
    greeting: (name: string) => `Hoi ${name},`,
    thanks: "Bedankt voor het boeken van een gesprek met mij.",
    calConfirm:
      "Je hebt al een bevestigingsmail ontvangen met een link om bij het gesprek te komen.",
    prepTitle: "Wil je het gesprek gebruiken om alvast aan je website te werken?",
    prepIntro: "Dan helpt het om je tekst en content zo veel mogelijk voor te bereiden.",
    questions: "Heb je vragen? Stuur gerust een mail naar",
    signoff: "Tot dan!",
  },
  en: {
    preview: "Thanks for booking a call.",
    greeting: (name: string) => `Hi ${name},`,
    thanks: "Thank you so much for booking a call with me.",
    calConfirm:
      "You should have already received a confirmation email with a link to join the call.",
    prepTitle: "If you'd like to use the call to start working on your website,",
    prepIntro: "it would help to prepare your text and content as much as possible.",
    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>{t.calConfirm}</Text>

          <Hr style={divider} />

          <Text style={text}>
            {t.prepTitle} {t.prepIntro}
          </Text>
          ...
          <Text style={text}>
            {t.questions}{" "}
            <Link href="mailto:info@dehaaswebservice.nl" style={link}>
